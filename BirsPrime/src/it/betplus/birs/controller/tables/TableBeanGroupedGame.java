...
@ManagedBean(name = "tableBeanGroupedGame")
@SessionScoped
public class TableBeanGroupedGame extends BaseTableBean {
	...
	public TableBeanGroupedGame() throws DataLayerException {
	...
	public void setListDataFromSource(ArrayList<Object> params)
		...
		try {
			...
			List<MeterfactGame> m = MeterDAO.getInstance()
					.retrieveMeter_grouped_games(reportBean.getDataS(),
							reportBean.getDataE(),
	...
	public void setFilteredTableList(List<MeterfactGame> filteredTableList) {
		TableBeanGroupedGame.filteredTableList = filteredTableList;
	}
	 ...
	 * TableBeanGroupedGame.setFilteredTotals(); } else {
