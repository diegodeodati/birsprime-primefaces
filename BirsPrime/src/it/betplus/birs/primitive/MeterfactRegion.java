 ...
 */
public class MeterfactRegion extends Meterfact implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1042160664112092443L;
	...
	public void sumValue(MeterfactRegion add) {
	...
	public MeterfactRegion clone() {

		MeterfactRegion clone = new MeterfactRegion();
	...
	public String toString(){
		return getSpaziodim().getRegione().getNome()+"-"+getSpaziodim().getRegione().getIdReg();
	}
}
